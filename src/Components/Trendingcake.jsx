...
const Trendingcake = () => {
  ...
  return (
    ...
    <div className="flex justify-center py-5 pt-10">
      ...
      <section className="flex flex-wrap gap-6 mt-10  pt-5 pb-10 justify-center items-center">
  ...
  <div className="absolute top-0 left-0 bg-[#733D26] text-white py-1 px-2 rounded-tr-md rounded-bl-md">
    ...
    <button data-aos="fade-up" data-aos-duration="2000" className="w-[200px] h-[45px] bg-[#733D26] hover:bg-red-300 text-base font-bold text-white mx-auto rounded-xl">
     View all
    </button>
    </section>
      </>
